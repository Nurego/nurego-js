...
var MULTIPLE_PRICES = 'nr-default',
    FLAT_RATE = 'nr-default-flat',
 ...
 */
(function () {    
    var MULTIPLE_PRICES_CSS = 'http://js.nurego.com/v1/lib/css/themes.css',
    ...
    var p = {
        api_key: null,
        element_id: null,
        theme_class: MULTIPLE_PRICES,
        css_url: MULTIPLE_PRICES_CSS,
        select_url: '/?plan_eid=',
    ...
    this.NuregoTheme.createPricingTable = function() {
      ...
      if (p.theme_class === MULTIPLE_PRICES) {
