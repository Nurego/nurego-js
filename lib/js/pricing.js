...
(function() {
    ...
    function nr_init () {
        ...
        p = {
            ...
            element_id: false,
            theme: 'nr-default',
            css_url: 'http://nurego-pricing.bilberrysoft.com/lib/css/themes.css',
            select_url: '/?plan_id=',
        ...
        scr.async = true;
        scr.src = 'https://am-staging.nurego.com/v1/offerings?api_key=' //TODO document.location.protocol + '//..'
            + p.api_key
