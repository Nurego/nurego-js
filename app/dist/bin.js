...
var underscore, jquery, utils, constants, widgetFactory, backbone, loginModel, registrationModel, priceListModel, text, text_loginHTML, text_absHTML, absNuregoView, loginViewCtrl, text_priceListHTML, text_priceListNewHTML, text_priceListCSS, tosModel, text_priceListSingleTierHTML, priceListViewCtrl, text_registrationHTML, text_registrationCSS, registrationViewCtrl, text_tosHTML, text_termsOfServiceCSS, tosStatusModel, tosViewCtrl, text_categoryHTML, text_categoryCSS, categoryModel, categoryViewCtrl, text_plansSwitcherHTML, text_plansSwitcherCSS, plansSwitcherViewCtrl, text_singleItemHTML, singleItemModel, singleItemCtrl, text_absNuregoCss, NuregoWidgets;
(function () {
  // Baseline setup
  // --------------
...
priceListViewCtrl = function (bb, tmpl, tmplNew, utils, css, tosModel, absNuregoView, priceListSingleTierHTML, $Nurego) {
  var priceList = absNuregoView.extend({
    ...
    initialize: function (model, customTmpl) {
      ...
      this.model.fetch({
        dataType: 'jsonp',
        error: _.bind(this.modelHttpErrorsHandler, this)  //error:function(a,b,c){debugger;}
  ...
  return priceList;
}(backbone, text_priceListHTML, text_priceListNewHTML, utils, text_priceListCSS, tosModel, absNuregoView, text_priceListSingleTierHTML, jquery);
...
registrationViewCtrl = function (bb, tmpl, utils, css, absNuregoView, $Nurego) {
  var activation = absNuregoView.extend({
    ...
    completeRegistration: function () {
      ...
      var apiParams = utils.URLToArray(window.location.href)['api-params'];
...
text_categoryHTML = '<style>\n\t.headerWrapper{\n\t\t\tpadding: 5px;\n  \t\ttext-align: left;\n\t}\n\n\t.itemsWrapper{\n\t  /*display: flex;\n\t  display: -webkit-flex;*/\n\t  float:left;\n\t  text-align: left;\n\t  min-height: 185px;\n\t}\n\n\t.singleItem{\n\t  /*flex: 1;\n\t  -webkit-flex: 1;*/\n\t  /*max-width: 225px;*/\n\t  position:relative;\n\t}\n\n\t.singleItem img {\n\t  /*position: absolute;\n\t  right: 8px;\n\t  width: 25px;\n\t  height: 25px;\n\t  top: 8px;*/\n\t}\n\n\t.name {\n\t    font-size: 18px;\n\t    font-weight: bold;\n\t    margin-top: 30px;\n\t    margin-bottom: 10px;\n\t}\n\n\t.publisher {\n\t    font-size: 11px;\n\t    font-weight: bold;\n\t    margin-bottom: 20px;\n\t}\n\n\t.section {\n\t    border-bottom: 2px solid #e0e1e4;\n\t    padding-bottom: 35px;\n\t    padding: 0px;\n\t}\n\n\t.widget_wrapper {\n\t\tdisplay: none;\n\t\tposition:absolute;\n\t\ttop:0px;\n\t\tleft:0px;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t\tbackground:white;\n\t}\n\n\t.close_widget{\n\t\tposition: absolute;\n\t\ttop:15px;\n\t\tleft:15px;\n\t\tfont-weight: bold;\n\t\tfont-size:14px;\n\t\t/*color:#46ad00;*/\n\t\tcolor:#1acca2;\n\t\tcursor: pointer;\n\t}\n\n\t.show_item .widget_wrapper {\n\t\tdisplay: block;\n\t}\n\n\t.widget_holder{\n\t\tmargin-top:0px !important;\n\t}\n\n\t.widget_holder {\n\t    position: fixed;\n\t    height: 100%;\n\t    width: 100%;\n\t    z-index: 99999;\n\t    background-color: white;\n\t}\n\n\t.close_widget {\n\t    position: absolute;\n\t    top: 15px;\n\t    left: 15px;\n\t    font-weight: bold;\n\t    font-size: 18px;\n\t    z-index: 9999999;\n\t    background-color: white;\n\t    padding: 0px 10px;\n\t}\n\n\t.catalog-tile {\n\t\t\tcursor: pointer;\n\t    -webkit-font-smoothing: antialiased;\n\t    box-sizing: border-box;\n\t    color: rgb(0, 0, 0);\n\t    display: inline-block;\n\t    font-family: \'GE Inspira Sans\', sans-serif;\n\t    font-size: 16px;\n\t    height: 170px;\n\t    line-height: 20px;\n\t    margin-bottom: 10px;\n\t    margin-left: 0px;\n\t    margin-right: 10px;\n\t    margin-top: 10px;\n\t    padding-bottom: 0px;\n\t    padding-left: 0px;\n\t    padding-right: 0px;\n\t    padding-top: 0px;\n\t    position: relative;\n\t    width: 267px;\n\t}\n\n\t.catalog-tile::before {\n\t    position: absolute;\n\t    right: 10%;\n\t    bottom: 0;\n\t    left: 10%;\n\t    height: 15%;\n\t    border-radius: 100%;\n\t    box-shadow: 0 0 15px rgba(0,0,0,.5);\n\t    content: \'\';\n\t}\n\n\t.catalog-tile__content {\n\t    position: absolute;\n\t    top: 0;\n\t    right: 0;\n\t    bottom: 0;\n\t    left: 0;\n\t    padding: 1.1875rem;\n\t    border: 1px solid #1acca2;\n\t    background: #fff;\n\t}\n\n\ta.catalog-tile__link {\n\t    position: absolute;\n\t    top: 0;\n\t    left: 0;\n\t    width: 100%;\n\t    height: 100%;\n\t    z-index: 100;\n\t}\n\n\th3.catalog-tile__title.mb-- {\n\t    font-size: 14px;\n\t    font-weight: 700;\n\t    line-height: 1em;\n\t}\n\n\t.catalog-tile__shortdescription{\n\t\tfont-size: 12px;\n\t\tline-height: 1.6666666667;\n\t\toverflow: hidden;\n\t\theight: 65px;\n\t}\n\n\timg.catalog-tile__icon {\n\t    position: absolute;\n\t    bottom: 1.1875rem;\n\t    left: 1.1875rem;\n\t    /*height: 30px;*/\n\t\t\theight: 20px;\n\t    border: 0px;\n\t}\n\n\t.catalog-tile__content:focus, .catalog-tile__content:hover{\n\t\tpadding: 1.0625rem;\n    border-width: 3px;\n    /*box-shadow: 0 3px 4px -1px rgba(209,219,208,.8);*/\n\t\tbox-shadow: 0 3px 4px -1px #1acca2;\n\t}\n\n\t.catalog-tile__content::after {\n    position: absolute;\n    top: -6px;\n    right: -14px;\n    width: 38px;\n    height: 23px;\n    -webkit-transform: rotate(45deg);\n    transform: rotate(45deg);\n    /*border-bottom: 1px solid #46ad00;*/\n\t\tborder-bottom: 1px solid #1acca2;\n    background-color: #eaeaea;\n    content: \'\';\n}\n\n.catalog-tile__content:focus::after,\n.catalog-tile__content:hover::after {\n    top: -7px;\n    right: -15px;\n    /*border-bottom: 3px solid #46ad00;*/\n\t\tborder-bottom: 3px solid #1acca2;\n}\n\n\tdiv.section{\n\t\twidth: 98%;\n\t\tmax-width: 73.125rem;\n\t\tmargin-right: auto;\n\t\tmargin-left: auto;\n\t\tpadding-right: 1%;\n\t\tpadding-left: 1%;\n\t}\n\n\t.embossed-line {\n    position: relative;\n    margin: 0;\n    padding: 0;\n    border-top: 1px solid #d8d8d8;\n\t\tclear:both;\n}\nhr {\n    height: 0;\n    border: 0;\n    border-top: 1px solid #d8d8d8;\n}\n\n.embossed-line::before {\n    display: block;\n    position: absolute;\n    top: 0;\n    right: 0;\n    bottom: 0;\n    left: 0;\n    border-top: 1px solid #fff;\n    content: \'\';\n}\n\n.banner--dark {\n    background-color: #333;\n}\n.banner {\n    height: 160px;\n}\n\n.banner__image {\n    height: 100%;\n    margin: 0 auto;\n    background-repeat: no-repeat;\n}\n.vw {\n    width: 98%;\n    max-width: 73.125rem;\n    margin-right: auto;\n    margin-left: auto;\n    padding-right: 1%;\n    padding-left: 1%;\n}\n.banner__labels--light {\n    padding-top: 50px;\n    color: #fff;\n}\n.banner__labels {\n    position: relative;\n    margin-top: 0;\n}\n.alpha {\n    font-size: 58px;\n    line-height: 1;\n    margin-bottom: 1.25rem;\n    font-weight: 400;\n}\n.banner__image--dark {\n    /*background-image: url(https://www.predix.io/assets/images/catalog/banner-dark.png);*/\n}\n\n</style>\n\n\n<section class="banner banner--dark" role="region">\n\t<img src="http://nurego.com/wp-content/uploads/2015/09/Complete_ElectricRain.-Transparent-website-30pct-pdn.png" style="position: relative;top: 65px;right: -60px;">\n\t<div class="vw banner__image banner__image--dark">\n\t\t<h1 class="alpha banner__labels banner__labels--light" style="text-align:center; margin-top: -35px;">\n\t\t\t<!-- <h1 class="alpha banner__labels banner__labels--light"> -->\n\t\t\tCatalog\n\t\t\t<!-- Predix Catalog -->\n\t\t</h1>\n\t</div>\n</section>\n\n{{ if(obj.data.length == 0) {  }}\n\n<div class="alert alert-info ajaxErrorMsg" role="alert" >\n\t\t<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>\n\t\t<span class="txt">\n\t\t\tNo eligible offers found\n\t\t</span>\n</div>\n\n{{ } }}\n\n\n{{ for (category in obj.data ) { }}\n\t<div class="section">\n\t\t<div class="headerWrapper">\n\t\t\t<h1>\n\t\t\t\t\t{{=obj.data[category].name}}\n\t\t\t</h1>\n\t\t\t<h5>\n\t\t\t\t {{=obj.data[category].description}}\n\t\t\t</h5>\n\t\t</div>\n\n\t\t<div class="itemsWrapper">\n\t\t{{ for(item in obj.data[category].services.data) {  }}\n\n\n\t\t<div class="catalog-tile singleItem" data-id="{{=obj.data[category].services.data[item].id}}">\n\t\t\t<div>\n\t\t\t\t<div class="catalog-tile__content">\n\t\t\t\t\t<a href="javascript:void(0)"></a>\n\t\t\t\t\t<h3 class="catalog-tile__title mb--">\n\t\t\t\t\t\t{{=obj.data[category].services.data[item].name}}\n\t\t\t\t\t</h3>\n\t\t\t\t\t<div class="catalog-tile__shortdescription">\n\t\t\t\t\t\t{{=obj.data[category].services.data[item].description}}\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<!-- <img ng-src="https://www.predix.com/sites/default/files/catalog_4p_logo.png" class="catalog-tile__icon" alt="Service Icon" src="https://www.predix.com/sites/default/files/catalog_4p_logo.png"> -->\n\t\t\t\t\t<img src="http://gdurl.com/Otz2" class="catalog-tile__icon" alt="Service Icon">\n\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\n\t\t\t<!-- <div class="singleItem" data-id="{{=obj.data[category].services.data[item].id}}">\n\t\t\t\t<img src="https://cdn1.iconfinder.com/data/icons/logotypes/32/github-128.png" height="45px" width="45px" />\n\t\t\t\t<div class="name">\n\t\t\t\t\t{{=obj.data[category].services.data[item].name}}\n\t\t\t\t</div>\n\n\t\t\t\t<div class="publisher">\n\t\t\t\t\tGE Software\n\t\t\t\t</div>\n\n\t\t\t\t<div class="desc">\n\t\t\t\t\t{{=obj.data[category].services.data[item].description}}\n\t\t\t\t</div>\n\t\t\t</div> -->\n\n\t\t{{\t}\t}}\n\t\t</div>\n\n\t</div>\n\t<hr class="embossed-line"></hr>\n{{ } }}\n\n<div class="alert alert-danger ajaxErrorMsg" role="alert" style="display:none">\n\t  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>\n\t  <span class="sr-only">Error:</span>\n\t  <span class="txt"></span>\n</div>\n\n<div class="widget_wrapper">\n\t<div class="close_widget"> < Back to Catalog</div>\n\t<div class="widget_holder"></div>\n</div>\n';
...
text_plansSwitcherHTML = '\n<div class="plans_wrapper">\n\n\t{{for(var planObj in obj.offering.plans.data) { }}\n\t\t\t{{ if(obj.offering.plans.data[planObj].id == obj.urlParams[\'sub-plan-id\']) { }}\n\t\t\t\t\t<div class="plan-wrapper selected">\n\t\t\t{{ } else{ }}\n\t\t\t\t\t<div class="plan-wrapper">\n\t\t\t{{ } }}\n\n\n\t\t\t\t\t\t\t<h3>{{= obj.offering.plans.data[planObj].name }} </h3>\n\t\t\t\t\t\t\t\t\t{{ if(obj.offering.plans.data[planObj].discounts.count != 0) { }}\n\t\t\t\t\t\t\t\t\t<div class="ribbon-wrapper-green">\n\t\t\t\t\t\t\t\t\t\t\t<div class="ribbon-green">\n\t\t\t\t\t\t\t\t\t\t\t\t{{=obj.offering.plans.data[planObj].discounts.data[0].days_to_apply}} days Free\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t{{ } }}\n\n\n\t\t\t{{ if(obj.offering.plans.data[planObj].id == obj.urlParams[\'sub-plan-id\']) { }}\n\t\t\t\t\t<div class="select-btn-wrapper selected">\n\n\t\t\t{{ } else{ }}\n\t\t\t\t\t<div class="select-btn-wrapper">\n\t\t\t{{ } }}\n\t\t\t\t\t\t\t{{ _.each(obj.offering.plans.data[planObj].features.data, function(item) { }}\n\t\t\t\t\t\t\t\t\t\t\t{{ if(item.name === "recurring"){ }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="row price" style="margin:auto; text-align:left;">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="col-md-4">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<b style="font-size:18px;">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tPrice\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</b>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="col-md-8">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<b style="background:green; font-size:18px;">\n\t\t\t\t\t\t\t\t\t\t\t${{\tprint(item.price.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, ",")) }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</b>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t{{ } }}\n\t\t\t\t\t\t\t{{ }); }}\n\n\t\t\t\t\t\t\t\t\t<form>\n\t\t\t\t\t\t\t\t\t\t\t<input type="hidden" class="form-control" value="{{=obj.offering.plans.data[planObj].id }}" name="plan_id">\n\t\t\t\t\t\t\t\t\t\t\t<input class="btn btn-default btn-xl selectPlan" data-plan="{{=obj.offering.plans.data[planObj].id }}" value="Select"/>\n\t\t\t\t\t\t\t\t\t</form>\n\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t{{ _.each(obj.offering.plans.data[planObj].features.data, function(item) { }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t{{ if(item.name != "recurring"){ }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <div class="row" style="margin:auto; text-align:left;">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="col-md-9">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{=item.name}}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class="col-md-3">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{ if(item.max_unit === 0 ) { }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class="fa-check-circle fa" style="font-size:18px;"></span>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{ }else{ }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{=item.max_unit}}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{ } }}\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t{{ } }}\n\t\t\t\t\t\t\t{{ }); }}\n\t\t\t\t\t</div>\n\t\t\t{{ }; }}\n\n</div>\n<div class="alert alert-danger ajaxErrorMsg" role="alert" style="display:none">\n\t  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>\n\t  <span class="sr-only">Error:</span>\n\t  <span class="txt"></span>\n</div>\n';
text_plansSwitcherCSS = '/*.simple_3_tier {\n    font-family:"Lato",Helvetica,Arial,sans-serif;\n    float: left;\n    margin: 0 auto;\n}\n.simple_3_tier table {\n    width: auto;\n    border-collapse: collapse;\n    background: #fff;\n}\n.simple_3_tier td,\n.simple_3_tier th {\n    border: 1px solid #e8e8e8;\n    vertical-align: middle;\n}\n.simple_3_tier td {\n    color: #707383;\n    font-size: 14px;\n    line-height: 18px;\n}\n.simple_3_tier thead th,\n.simple_3_tier tfoot th {\n    border: none;\n}\n.simple_3_tier thead td {\n    height: 30px;\n    background: #fff;\n    font-size: 11px;\n    color: #9799a2;\n    text-transform: uppercase;\n    text-align: center;\n    font-weight: bold;\n    padding: 0 10px;\n}\n.simple_3_tier tbody th {\n    text-align: left;\n    font-size: 12px;\n    padding: 10px 20px;\n    font-weight: normal;\n}\n.simple_3_tier tbody td {\n    text-align: center;\n    padding: 0 10px;\n}\n.simple_3_tier tfoot td {\n    text-align: center;\n    padding: 12px 0;\n}\n.simple_3_tier th.nr-price {\n    color: #666;\n    height: 32px;\n    background-color: #fff;\n    text-align: left;\n    font-weight: normal;\n}\n.simple_3_tier td.nr-price {\n    color: #f26522;\n    font-size: 20px;\n    font-weight: bold;\n    background-color: #fff;\n}\n.simple_3_tier tfoot a {\n    display: inline-block;\n    color: #fff;\n    background: #9799A2;\n    height: 32px;\n    line-height: 32px;\n    text-align: center;\n    padding: 0 15px;\n    margin-left: 5px;\n    margin-right: 5px;\n    font-size: 10px;\n    text-transform: uppercase;\n    font-weight: bold;\n    text-decoration: none;\n    -webkit-border-radius: 4px;\n    -moz-border-radius: 4px;\n    border-radius: 4px;\n}\n\n.simple_3_tier tfoot a:hover {\n    background: #959595;\n    text-decoration:underline;\n}\n\n.simple_3_tier .nr-check {\n    width: 16px;\n    height: 16px;\n    display: block;\n    margin: 0 auto;\n}\n\n.simple_3_tier .nr-check.nr-yes {font-size:16px; color:#69be28; }\n.simple_3_tier .nr-check.nr-no { font-size:16px; color:#f26522;  }\n.simple_3_tier .nr-notify {\n    font-size: 14px;\n    font-weight: bold;\n    text-align: center;\n    line-height: 18px;\n    padding: 20px;\n    margin: 0 0 15px;\n    font-family: Tahoma, Verdana, Segoe, sans-serif;\n    letter-spacing: 1px;\n}\n.simple_3_tier .nr-notify.nr-red {\n    background: #f2dede;\n    color: #a94442;\n}\n.simple_3_tier .nr-notify.nr-yellow {\n    background: #fcf8e3;\n    color: #986d3b;\n}\n.simple_3_tier .nr-container {\n    height: 304px;\n    margin: 0 auto 10px;\n}\n.simple_3_tier .nr-container.nr-loading {\n    background: url("../images/loader.gif") 50% 50% no-repeat;\n}\n.simple_3_tier .nr-container.nr-empty {\n    background: url("../images/empty.gif") 50% 50% no-repeat;\n}\n\n.nr-signup-div {\n    margin: 40px auto;\n    width: 100%;\n    text-align: center;\n}\n.nr-signup, .nr-go-signup, .nr-go-update {\n    text-decoration: none;\n    background: transparent;\n    border: 2px solid #dfe1e6;\n    min-width: 120px;\n    font-weight: 400;\n    margin-top: 0.5em;\n    color: #565a6b;\n    text-transform: uppercase;\n    padding: 0.625em 1.125em;\n    font-size: 0.857em;\n    margin-left: 5px;\n}\n\n.nr-signup:hover, .nr-go-signup:hover {\n    color: white;\n    background: #565a6b;\n    border: 2px solid white;\n}\n\n.simple_3_tier .nr-plan-selected {\n    background: #f26522; \n}\n\n.simple_3_tier .nr-plan-selected:hover {\n    background: #f26522; \n}\n\n.nr-discount {\n  text-transform:uppercase;\n  padding: 10px 10px 10px 10px !important;\n  background-color: #f26522;\n  color: wheat !important;\n}\n.nr-trial-days {\n  font-size: 10px;\n}\n\n.nr-price-period {\n  font-size: 14px;\n  font-weight: normal;\n  color: #69be28;\n}\n\n.nr-nurego-tag-line{\n  margin-top: 10px;\n    text-align: right;\n  font-size: 12px;\n}\n\n.nr-nurego-cc-require{\n  margin-top: 10px;\n    text-align: right;\n  font-size: 14px;\n}\n\n.nr-nurego-tag-line a{\n  color: #69be28;\n}\n\n.nr-cc td {\n  font-size: 12px;  \n}\n\n\n.on-offswitch {\n    display: inline-block;\n    margin-bottom: 15px;\n    position: relative; width: 74px;\n    -webkit-user-select:none; -moz-user-select:none; -ms-user-select: none;\n}\n\n.on-offswitch-checkbox {\n    display: none;\n}\n.on-offswitch-label {\n    display: block; overflow: hidden; cursor: pointer;\n    border: 1px solid #DFE1E6; border-radius: 0px;\n}\n.on-offswitch-inner {\n    display: block; width: 200%; margin-left: -100%;\n    -moz-transition: margin 0.3s ease-in 0s; -webkit-transition: margin 0.3s ease-in 0s;\n    -o-transition: margin 0.3s ease-in 0s; transition: margin 0.3s ease-in 0s;\n}\n.on-offswitch-inner:before, .on-offswitch-inner:after {\n    display: block; float: left; width: 50%; height: 7px; padding: 0; line-height: 7px;\n    font-size: 14px; color: white; font-family: Trebuchet, Arial, sans-serif; font-weight: bold;\n    -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;\n}\n.on-offswitch-inner:before {\n    content: "";\n    padding-left: 10px;\n    background-color: #FFFFFF; color: #FFFFFF;\n}\n.on-offswitch-inner:after {\n    content: "";\n    padding-right: 10px;\n    background-color: #FFFFFF;\n    text-align: right;\n}\n.on-offswitch-switch {\n    display: block; width: 37px; margin: 1px;\n    background: #C59DD7;\n    border: 1px solid #DFE1E6; border-radius: 0px;\n    position: absolute; top: 0; bottom: 0; left: 35px;\n    -moz-transition: all 0.3s ease-in 0s; -webkit-transition: all 0.3s ease-in 0s;\n    -o-transition: all 0.3s ease-in 0s; transition: all 0.3s ease-in 0s; \n}\n\n.monthly-checked .on-offswitch-inner {\n    margin-left: 0;\n}\n\n.monthly-checked .on-offswitch-switch {\n    left: 0px; \n}\n\n.switch-monthly {\n    padding-right: 13px;\n    text-align: -webkit-right;   \n    color: #C59DD7;\n    font-size: 11px;\n    cursor: pointer;\n}\n\n.switch-yearly {\n    padding-left: 11px;\n    color: #6D6D6E;\n    font-size: 11px;\n    cursor: pointer;\n}\n\n.switcher-full {\n    display: none;\n    margin-left: 620px;\n    margin-bottom: 10px;\n}\n\n@media only screen and (max-width: 1260px) {\n  .switcher-full {\n    margin-left: 542px;\n  }\n}\n@media only screen and (max-width: 1150px) {\n  .switcher-full {\n    margin-left: 475px;\n  }\n}\n@media only screen and (max-width: 1050px) {\n  .switcher-full {\n    margin-left: 455px;\n  }\n}\n@media only screen and (max-width: 1020px) {\n  .switcher-full {\n    margin-left: 426px;\n  }\n}\n@media only screen and (max-width: 980px) {\n  .switcher-full {\n    margin-left: 400px;\n  }\n}\n@media only screen and (max-width: 913px) {\n  .switcher-full {\n    margin-left: 340px;\n  }\n}\n@media only screen and (max-width: 825px) {\n  .switcher-full {\n    margin-left: 200px;\n  }\n}\n\n*/';
plansSwitcherViewCtrl = function (bb, tmpl, utils, css, absNuregoView, $Nurego) {
  var plansSwitcher = absNuregoView.extend({
    tagName: 'div',
    className: 'plansSwitcher',
    template: _.template(tmpl),
    events: { 'click .selectPlan': 'select' },
    initialize: function (model, customTmpl) {
      //this.__super__.initialize.apply(this);
      this.params = utils.URLToArray(window.location.href);
      this.selectedPlan = '';
...
}(backbone, text_plansSwitcherHTML, utils, text_plansSwitcherCSS, absNuregoView, jquery);
text_singleItemHTML = '<center>\n\n  <div class="alert alert-danger ajaxErrorMsg" role="alert" style="display:none">\n        <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>\n        <span class="sr-only">Error:</span>\n        <span class="txt"></span>\n  </div>\n\n  <main>\n  \t<section>\n  \t\t<div>\n  \t\t\t<h1>\n  \t\t\t\t{{=obj.name}}\n  \t\t\t</h1>\n  \t\t\t<h3>\n  \t\t\t\tPublished April 28, 2015\n  \t\t\t</h3>\n  \t\t</div>\n  \t</section>\n  \t<section>\n          <div>\n  \t\t\t\t\t<p>\n  \t\t\t\t\t\t<!-- <img src="http://www.alberttoledo.com/img/icons/social/github.png" id="IMG_47" alt=\'\' />  -->\n  \t\t\t\t\t\t<!-- <img src="{{=obj.icon}}" alt=\'\' /> -->\n  \t\t\t\t\t\t<!-- <a href="https://livesample.grc-apps.svc.ice.ge.com/">View Live Sample</a> -->\n  \t\t\t\t\t</p>\n          </div>\n  \t\t\t\t\t<div>\n  \t\t\t\t\t\t<p>\n  \t\t\t\t\t\t\t{{=obj.description}}\n  \t\t\t\t\t\t\t<!-- The Predix Asset Service provides asset modeling and data management with real time intelligence, and provides insight into the relationships and connections between independently managed assets. Industrial Internet applications are generally machine-focused. The Asset service enables application developers to import, create, and store asset models that describe machine types, as well as create instance representations for those machines. -->\n  \t\t\t\t\t\t</p>\n  \t\t\t\t\t</div>\n\n            {{ if( obj.service_id == "reference_app" ){ }}\n\n              <div class="text--small">\n                  <p>Use the Reference App to create an app that monitors machine operations, reports irregularities, and analyzes patterns of behavior and performance over time. The app integrates major components of Predix, including Asset, Time Series, and Predix Machine services.</p>\n                  <p>To gain a better understanding of the Reference App, view the video:</p>\n                  <br/>\n                  <p>\n                    <iframe width="560" height="315" src="https://www.youtube.com/embed/2MGPTJ8yjyc" frameborder="0" allowfullscreen=""></iframe>\n                  </p>\n                  <br/>\n                  <p>You must be signed into Predix to see the demo.</p>\n                  <p>To access the code directly, click the View on GitHub link below and search for the repo "predix-rmd-ref-app."</p>\n              </div>\n\n              <a href="https://github.com/predixdev" target="_blank" class="link link--underline">View on GitHub</a>\n              <br/>\n            {{  } }}\n\n            <nurego-widget style="width:100%;height:550px;"\n              name="price_list"\n              preview="true"\n              css="{{=obj.css}}"\n              product-id="{{=obj.service_id}}"\n              sso="false">\n            </nurego-widget>\n\n\n  \t</section>\n  </main>\n\n\n\n  <style>\n  h1 {\n      font-size: 18px !important;\n  }\n\n  h4,h3 {\n      font-size: 14px !important;\n  }\n\n  body , html {\n    width: 98%;\n    margin-right: auto;\n    margin-left: auto;\n    padding-right: 1%;\n    padding-left: 1%;\n    padding-top:65px;\n  }\n  </style>\n\n</center>\n';
...
singleItemCtrl = function (bb, tmpl, utils, css, singleItemModel, absNuregoView, $Nurego) {
  /*
          categoryViewCtrl: '../components/catalog/category/category.ctrl',
          categoryHTML: '../components/catalog/category/category.html',
          categoryModel: '../models/category',
...
text_absNuregoCss = '@media -sass-debug-info{filename{font-family:file\\:\\/\\/\\/home\\/eyal\\/Repos\\/nurego-js\\/app\\/src\\/styles\\/main\\.scss}line{font-family:\\000031}}\nnurego-widget {\n  display: block;\n  height: 100%;\n  width: 100%;\n}\n\n@media -sass-debug-info{filename{font-family:file\\:\\/\\/\\/home\\/eyal\\/Repos\\/nurego-js\\/app\\/src\\/styles\\/main\\.scss}line{font-family:\\000037}}\n.alert {\n  display: relative;\n  z-index: 9999999;\n}\n\n@media -sass-debug-info{filename{font-family:file\\:\\/\\/\\/home\\/eyal\\/Repos\\/nurego-js\\/app\\/src\\/styles\\/main\\.scss}line{font-family:\\0000312}}\n#checkbox label {\n  line-height: 175%;\n}\n\n/******************CHECK BOXES ******************/\n\n/*# sourceMappingURL=main.css.map */\n';
NuregoWidgets = function (constants, utils, widgetFactory, loginModel, registrationModel, priceListModel, loginViewCtrl, priceListViewCtrl, registrationViewCtrl, tosViewCtrl, categoryViewCtrl, plansSwitcherViewCtrl, categoryModel, singleItemCtrl, singleItemModel, tosModel, tosStatusModel, absNuregoCss, $Nurego) {
  var app, lib;
  app = {};
  lib = {
    constants: constants,
  ...
  return app;
}(constants, utils, widgetFactory, loginModel, registrationModel, priceListModel, loginViewCtrl, priceListViewCtrl, registrationViewCtrl, tosViewCtrl, categoryViewCtrl, plansSwitcherViewCtrl, categoryModel, singleItemCtrl, singleItemModel, tosModel, tosStatusModel, text_absNuregoCss, jquery);
