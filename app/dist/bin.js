...
var underscore, jquery, utils, constants, widgetFactory, backbone, loginModel, registrationModel, priceListModel, text, text_loginHTML, absNuregoView, loginViewCtrl, text_priceListHTML, text_priceListCSS, tosModel, text_priceListSingleTierHTML, priceListViewCtrl, text_registrationHTML, text_registrationCSS, registrationViewCtrl, text_tosHTML, text_termsOfServiceCSS, tosStatusModel, tosViewCtrl, text_categoryHTML, text_categoryCSS, categoryModel, categoryViewCtrl, text_absNuregoCss, Nurego;
(function () {
  // Baseline setup
  // --------------
