...
priceListViewCtrl = function (bb, tmpl, utils, css, tosModel, absNuregoView, priceListSingleTierHTML, $Nurego) {
  ...
  return priceList;
}(backbone, text_priceListHTML, utils, text_components_price_list_price_listcss, tosModel, absNuregoView, text_priceListSingleTierHTML, jquery);
...
registrationViewCtrl = function (bb, tmpl, utils, css, absNuregoView, $Nurego) {
  ...
  return activation;
}(backbone, text_registrationHTML, utils, text_components_registration_registrationcss, absNuregoView, jquery);
...
tosViewCtrl = function (bb, tmpl, utils, css, tosStatusModel, tosModel, absNuregoView, $Nurego) {
  ...
  return activation;
}(backbone, text_tosHTML, utils, text_components_terms_of_service_terms_of_servicecss, tosStatusModel, tosModel, absNuregoView, jquery);
...
categoryViewCtrl = function (bb, tmpl, utils, css, categoryModel, absNuregoView, $Nurego) {
  ...
  */
  ...
  return categoryView;
}(backbone, text_categoryHTML, utils, text_components_catalog_category_categorycss, categoryModel, absNuregoView, jquery);
